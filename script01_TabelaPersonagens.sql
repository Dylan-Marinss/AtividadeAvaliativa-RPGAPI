...
VALUES (1, 1, 23, 17, 33, 'Jim Carry', 100),
(2, 1, 25, 15, 30, 'Valter Costa Junior', 100),
(3, 3, 21, 18, 35, 'Kishimoto', 100),
(4, 2, 18, 18, 37, 'Papai noel', 100),
(5, 1, 17, 20, 31, 'Robson', 100),
(6, 3, 13, 21, 34, 'Neymar', 100),
(7, 2, 11, 25, 35, 'Alex o leão', 100);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Classe', N'Defesa', N'Forca', N'Inteligencia', N'Nome', N'PontosVida') AND [object_id] = OBJECT_ID(N'[TB_PERSONAGENS]'))
    SET IDENTITY_INSERT [TB_PERSONAGENS] OFF;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250911005852_InitialCreate', N'9.0.9');
